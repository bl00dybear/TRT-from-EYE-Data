...
<link href="https://fonts.googleapis.com/css2?family=Linux+Libertine+O&family=Linux+Biolinum+O&display=swap" rel="stylesheet">
...
<div class="page">
  ...
  <div class="two-col">
    ...
    <!-- Evaluation: spans both or stays in flow — put full-width below -->
    ...
    <div>
      ...
      <ul class="notes">
        ...
        <li>Custom Score: composite score \( 100 \cdot \frac{R^2 + |\rho|}{2} \) where ρ is the Pearson correlation on the test set.</li>
      </ul>
    </div>
