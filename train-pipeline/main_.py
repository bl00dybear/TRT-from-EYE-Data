...
def split_data(cfg, train_df, X_train, y_train_full):
    ...
    return X_tr, y_tr, X_val, y_val, train_participants, val_participants
...
def main():
    ...
    X_tr, y_tr, X_val, y_val, train_participants, val_participants = split_data(cfg, train_df, X_train, y_train_full)
